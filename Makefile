...
mtm_drv.so: mtm.o joymouse.o mousebutton.o switcher.o
	gcc -shared -g -o mtm_drv.so mtm.o joymouse.o mousebutton.o switcher.o
...
switcher.o: mtm.h switcher.c
	gcc $(CFLAGS) $(INCLUDES) -c switcher.c -o switcher.o
